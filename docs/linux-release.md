...
artifacts/
  ...
  packages/
    ...
    cipher-snagem-editor-linux-x64-0.1.7.deb
...
`artifacts/packages/cipher-snagem-editor-linux-x64-0.1.7.deb`, to the Ubuntu
machine, then double-click it in GNOME Files or run:

```bash
sudo apt install ./cipher-snagem-editor-linux-x64-0.1.7.deb
```
